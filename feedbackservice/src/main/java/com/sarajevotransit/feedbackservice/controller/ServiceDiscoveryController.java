...
import com.sarajevotransit.feedbackservice.dto.ServiceInstanceInfoResponse;
...
public class ServiceDiscoveryController {
    ...
    @Value("${spring.application.name:feedbackservice}")
    private String serviceName;

    @Value("${eureka.instance.instance-id:${spring.application.name:feedbackservice}:${server.port:8080}}")
